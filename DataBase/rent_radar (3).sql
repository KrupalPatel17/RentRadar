...
INSERT INTO `tbl_owners` (`owner_id`, `owner_name`, `email`, `phone`, `addresh`, `password`) VALUES
(1, 'shree_ram', 'krupal561@gmail.com', 123456789, '32, parijat society gavendar Jahangirpura', '202cb962ac59075b964b07152d234b70'),
(2, 'krupal123', 'krupal561@gmail.com', 2147483647, '32, parijat society gavendar Jahangirpura', '202cb962ac59075b964b07152d234b70');
...
INSERT INTO `tbl_user` (`user_id`, `user_name`, `email`, `phone`, `address`, `password`) VALUES
(4, '0', 'krupal561@gmail.com', 2147483647, '32, parijat society gavendar Jahangirpura', '202cb962ac59075b964b07152d234b70'),
(5, 'ram', 'patelkrupal679@gmail.com', 2147483647, '32, parijat society gavendar Jahangirpura', '202cb962ac59075b964b07152d234b70'),
(6, 'krupal12', 'krupal561@gmail.com', 2147483647, '32, parijat society gavendar Jahangirpura', '202cb962ac59075b964b07152d234b70'),
(7, 'krupal', 'patelkrupal679@gmail.com', 2147483647, '32, parijat society gavendar Jahangirpura', '202cb962ac59075b964b07152d234b70');
...
--
ALTER TABLE `tbl_house`
  ADD CONSTRAINT `owner_id` FOREIGN KEY (`owner_id`) REFERENCES `tbl_owners` (`owner_id`);
COMMIT;
