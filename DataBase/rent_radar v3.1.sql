...
(17, '1c', 'Hare Krishna ', 'Gujarat Gas Circle ', 'Gujarat', 'Surat', 395003, 7, 'Furnished', 15999, 3, 4, 'No Violence Tolarated', 'img/images.jpg', 14);
...
(14, 'liral', 'patelkrupal679@gmail.com', '9898227601', '32, parijat society gavendar Jahangirpuraa', '202cb962ac59075b964b07152d234b70', 'uploads/download.png', 1, 1),
(15, 'pritesh', 'krupal561@gmail.com', '2147483647', '32, parijat society gavendar Jahangirpura', '202cb962ac59075b964b07152d234b70', 'uploads/download.png', 0, 1);
...
(11, 'tisha', 'liralpatel@gmail.com', '9979229601', '21d raj hansh , vesu ', '202cb962ac59075b964b07152d234b70', 1);
...
(8, 11, 1, 14, 'Goa', 'Margao', 8999, 'img/download.jpg'),
(9, 11, 1, 15, 'Rajasthan', 'Jaipur', 6000, 'img/download (1).jpg');
...
--
ALTER TABLE `tbl_watchlist`
  MODIFY `wtch_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
COMMIT;
