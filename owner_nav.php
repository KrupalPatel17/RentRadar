...
<form action="" method="POST" >
    <nav class="navbar fixed-top  border-bottom border-body" style="background-color: #ffffff00;">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">RentRadar</a>
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                ...
                <div class="offcanvas-body" style="background-color: #e3f2fd;">
                    ...
                    <form class="d-flex mt-3" role="search">
                        ...
                        <button class="" style="background-color: #ffffff00; border:none"name="btnlogout" type="submit">Logout</button>
                    </form>
                </div>
            </div>
        </div>
