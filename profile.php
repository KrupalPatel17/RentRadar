...
if (isset($_SESSION['users_id'])) {
    ...
    $sel = "SELECT * FROM tbl_user WHERE user_id=$user_id";
...
if (isset($_POST['btnadd'])) {
    ...
    $update_query = "UPDATE tbl_user SET user_name='$username', email='$email', phone='$number', address='$address' WHERE user_id=$user_id";
    ...
    <div class="form-container">
        ...
        <form action="" method="POST" id="productForm" enctype="multipart/form-data">
            <div class="input-container">
                ...
                <input type="text" id="username" name="username" placeholder="UserName" value="<?php echo $data['user_name'] ?>" required>
            </div>
            <div class="input-container">
            ...
            <div class="input-container">
                ...
                <input type="text" id="address" name="address" placeholder="Address" value="<?php echo $data['address'] ?>" required>
            </div>
